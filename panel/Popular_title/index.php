    ...
    <div class = 'table_catgory' >
        <table style = 'width : 95%'>
            ...
            <tr>
                ...
                <!-- settings -->
                <td id = 'setting_td'>
                    <a href="<?= asset('panel/popular_title/status.php?id='.$item->id);?>" class = 'changeStatus_button' >Change Status</a>
                </td>
                <td>
                    <a href="<?= asset('panel/popular_title/edit.php?id='.$item->id); ?>" class = 'edit_button'>Edit</a>
                </td>
                <td>
                    <a href = '<?= asset('panel/popular_title/delete.php?id='.$item->id); ?>' class = 'delete_button' onclick = 'functionCheck()'>Delete</a>
                </td>
            </tr>
           <?php  }  ?>
