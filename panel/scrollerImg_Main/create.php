<?php
    ...
    if (isset($_POST['title']) && $_POST['title'] !== "" &&
        ...
        if(checkImg('image')){
            ...
            if($path !== false){
                $operation =   operationsDataBase ("adidas", "INSERT INTO adidas.scrollerimg_main SET title = ?, path = ?, price = ?, body = ?, created_at = NOW()", $execute = [$_POST['title'], $path, $_POST['price'], $_POST['body']]);
...
<body>
    ...
    <div style = 'padding-top:150px'>
        <form action="<?= url('panel/scrollerImg_Main/create.php'); ?>" method="post" class = 'form_create_category' enctype="multipart/form-data">
