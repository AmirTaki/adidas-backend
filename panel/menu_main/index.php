...
<body>
    ...
    <div class = 'table_catgory' >
        <table style = 'width : 95%'>
            ...
            <?php 
            $Table =   readTable ("adidas", "SELECT * FROM adidas.menu_main", $sigle = false, $execute = null);
            ...
            <tr>
                ...
                <!-- settings -->
                <td id = 'setting_td'>
                    <a href="<?= asset('panel/menu_main/status.php?id='.$item->id);?>" class = 'changeStatus_button' >Change Status</a>
                </td>
                <td>
                    <a href="<?= asset('panel/menu_main/edit.php?id='.$item->id); ?>" class = 'edit_button'>Edit</a>
                </td>
                <td>
                    <a href = '<?= asset('panel/menu_main/delete.php?id='.$item->id); ?>' class = 'delete_button' onclick = 'functionCheck()'>Delete</a>
                </td>
            </tr>
           <?php  }  ?>
        </table>
