...
<body>
    ...
    <?php require_once '../layouts/sidebar.php' ?>
        ...
        <a href="<?= asset('panel/scroller_video/create.php') ?>" class = 'create_button'>Create</a>
</div>
    <div class = 'table_catgory' >
        <table style = 'width : 95%'>
            ...
            <tr>
                ...
                <!-- settings -->
                <td id = 'setting_td'>
                    <a href="<?= asset('panel/scroller_video/status.php?id='.$item->id);?>" class = 'changeStatus_button' >Change Status</a>
                </td>
                <td>
                    <a href="<?= asset('panel/scroller_video/edit.php?id='.$item->id); ?>" class = 'edit_button'>Edit</a>
                </td>
                <td>
                    <a href = '<?= asset('panel/scroller_video/delete.php?id='.$item->id); ?>' class = 'delete_button' onclick = 'functionCheck()'>Delete</a>
                </td>
            </tr>
           <?php  }  ?>
