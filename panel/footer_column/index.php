...
<body>
    ...
    <div class = 'table_catgory' >
        <table style = 'width : 95%'>
            ...
            <?php 
            $Table =   readTable ("adidas", "SELECT * FROM adidas.footer_column", $sigle = false, $execute = null);
            ...
            <tr>
                ...
                <!-- settings -->
                <td id = 'setting_td'>
                    <a href="<?= asset('panel/footer_column/status.php?id='.$item->id);?>" class = 'changeStatus_button' >Change Status</a>
                </td>
                <td>
                    <a href="<?= asset('panel/footer_column/edit.php?id='.$item->id); ?>" class = 'edit_button'>Edit</a>
                </td>
                <td>
                    <a href = '<?= asset('panel/footer_column/delete.php?id='.$item->id); ?>' class = 'delete_button' onclick = 'functionCheck()'>Delete</a>
                </td>
            </tr>
           <?php  }  ?>
